...
def test_checkpoint_contains_no_derived_or_sample_level_state_and_roundtrips_logits():
    original = learner("confusion_residual")
    ...
    restored = learner("confusion_residual")
